...
assert.equal(effectiveMultiplierUnits(900,[bonusStage(900)]),3900);
...
assert.deepEqual(resolveRound(2000,3000,39),{won:true,at:39});
assert.equal(resolveRound(1.5,3,2),null);
assert.equal(resolveRound(2.5,100,2.5),null);
assert.equal(resolveRound(38,100,2.5),null);
assert.deepEqual(resolveRound(39,100,2.5),{won:true,at:39});
